...
## Acceptance Criteria
- [ ] Xác định rõ đây là bug rendering thật hay chỉ là screenshot-timing artifact — ghi kết luận vào ticket dù kết quả là gì.
- [ ] Nếu là bug thật: watermark tile preview chỉ vẽ trong đúng bounds vùng hiển thị ảnh, không tràn lên toolbar/nút bấm/tab UI xung quanh.
- [ ] Smoke test trên device thật xác nhận qua nhiều lần chọn ảnh khác nhau (ảnh dọc, ảnh ngang, ảnh vuông).
