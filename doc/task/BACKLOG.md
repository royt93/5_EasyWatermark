...
## BUGS_TO_FIX (10 todo, 2 deferred + 26 done) — ưu tiên P0 trước
...
| [BUG-36](todo/BUG-36-watermark-tile-preview-de-len-toan-bo-ui-chrome-man-editor.md) | P2 | M | Watermark tile preview đè lên toàn bộ UI chrome màn editor, không giới hạn trong vùng ảnh — phát hiện qua screenshot thật (2026-09-16), cần điều tra rõ có phải bug rendering hay chỉ screenshot-timing artifact |
